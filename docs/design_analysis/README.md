...
- **Threshold encryption of P_w** was not adopted as a core fix because binding `P_w` into the signed message already prevents coordinator front-running; threshold encryption adds complexity with limited additional benefit.
